<pre>
Who cant simulate/calc, cant win/chance 
...
dont lazy: calc til end   
dont hope in future.  
be calm: angry doesnt solve the problem and will cut your tree  
simulate 
...
Dont run from solving a problem. 
take ownership and responsibility and think you MUST care about it. Nobody will come to solve this. 
its not sunday that sucks, neither your work. its you with unmatched dreams or effort 
...
Taste everything before it goes out. Thats the only way you can quality control your own food(ref) 
...
This stuff isnt taught per se, you learn it bit by bit as you solve each problem that you face 
...
• dont assume your first sol is correct always 
...
Procrastinate.multitask.worring.perfection 
...
<pre>
Books, video, college, experience doesnt matter at all, as far as you cant imagine and solve problem inside your head.(blindfold) 
...
wake up late, near standup 
no work until it's too late 
see the funny video and read another thing 
</hr>
...
invcoie:number شک نکردی که چرا از ۲۰۰ شروع شد . صحت تست ازمون.

excel: staging and stich had different sync.

inventory+item-updated: ربطی به اینونتوری خالی نداشت و دلیل سرچ دوباره از اول میساخت.
و شک داشتی که ساهتن خالی درست است یا نه
Update db . Didnt consider cache. در نظر گرفتن علمل خارجی

CDN . نخوندن سورس کامل. ندونستن سیستم.
Anti Corruption layer. فهم سیستم
Stry. فهم سیستم.
Hdr. پچ و هک و داک تیپ بازی  به جای کشف باگ و بست پرکتیسش
Ao: پیگیری ترکه بابت اررور سمت خودشون
اخریا اصلا برن اپت بودی 

!!!!!!!!!!!
تمرکز.11
انگلیسی11
خواندن سورس کامل و فهمیدن پروسس نه کامپوننت بیس22.33
 هواندن دذاک و فهم اجرای دستور 22
 حواس پرتی در حین کارو گوش دادنو به تصورات 11
کنستانتین استف بود: بذرقه پارتی دوربین هاموش تسلط زودتر‌بر کد. اصرار الکی جاوااسکریپت انلی . مشورت:::پایین اوردن سطح..X . :::برنامه زبان . تد. صحبت . نه خولندن کلمه..
بازی بازی نکن یاد بگیری، سوال بپرس و مشکل حل کن. و بین راحل هل هم ببین 3.4
نظم از قبل میاد،3.4
حدسی همیشه خطا داره ولو ۱ درصد. 3.4
فعمیدن کامل منظور. 11
پیگیری تمرین هم‌تیمیا 22
هدف فقط زدن وصل ظاهری مسیله نباشه، لوله کشی با پلاستیک. 3.4
انالیژ کن چقدر طچل میکشه. 3..4
تست برای چک نه تست یزلی تایید حرفا. اصوبی تست کنیم. 3.4
...
5.doc: conclusion:PMA:
6.edge-cases: review:
</pre>

<pre>
دوست را گر صد هزار شک ره دهد
با تعامل میتوان تحلیل کرد
دشمن احمق به یک اخمی بس است
تا که روح و جسم را تحلیل ب﴾رد

صد در صد من، صدر صدارت دارم
صد سر ،سر من سرو سماور دارم
گر تو نشوی قانع به طبع بنده
صد در صد من سعی اجابت دارد
...
<pre>
 Memory as emotion recorded

باله و جیمناستیک ورزش انتلکت
مهندس اندازهدمیگیره با خط کش ولب دولوپر حسی اونارو
میسازه. خطکش و نقاله و گونیا..
فال گرفتن زیاذ...
گوش دادن موسیقی رادبو برای تمپرال لوب
Chess is not subjectove thinking type
9gag is time killer
زندگی‌هپشمند برای هر لحظض برنامه داری و پلن...
Every theory comes from experiment.
And you must learn cluster to bring ctx yo it, you must exprience it to find out.
همه از بچگی خوش بینی بد بینی رو یاد میگیرن. 
زبان هنر انتقال تفکر و احساسات است.
هنر نحوه‌ی بیان و انتقال حسهه.
بزرگسالی ینی مثل موتور بچگیت تصمیم نگیری
چرا فلسفه‌ی محض داریم، ولی فلسفه‌ی کاربردی نداریم؟
چرا زبان بینایی و چشایی نداربم؟ ولی گفتاری شنیداری داربم🥇

هنر ناحه سه بعدی مغز در مجسمه سازی است.
چه میشود اگر زبان گفتاری با شنیداری فرق داشت؟🥉

یا فثلم ها ژانر  دارند...
انسان‌های با تستی بالا رو دوس داریم 
Experiment, idea, thoughts, emotion, information
Art is form of language for above 

طراحی زبان خنثی و بدون احساسات.
هنر، تجربه حسی مشترک ما
هنر زبان(گفتاری شنیداری) جدیدی است برای انتقال تجربه، ایده، حس، اطلاعات، و اندیشه...
زبان گفتازی به غایت حس و عقیده رو نمیرسونه، سینما و هنر مکملن ، .‌
برای همین کتاب و سینما و تلویوزیون در مقابل هم بودند، چون برای بیان انتقال افکار در تضاد بودند. 

بدون حس مشترک، نمیتوان پیام و عمق حرف رو انتقال داد.ادبیات مشترک
بچه‌ی ونج ساله که میخاد استارتاپ میلیاردی بزنهه....
به حای افتتاح حساب براب پنج‌ساله ها، برای هوش های بالای پنج تستس حساب باز کنن.....
چگونه نیفهمیم یک احساس مربوط به تفکر است یا نع...
حیوان سالم به خونه برسه کوالا.زبان جامعه زنده موندن است.
Transition in music and rap in traditional disco
تفکر بر اساس تجربیات یا براساس ذهنیات ...🔥
تا بیست حرکتو نگاه کنید شظ چرت بود.

ادما مسایلشو با مشاغلشون حل مبکنند.
کار‌اشتباهی است که برای درخواست عذرخواهی کنبم و لگیم ببخشید
باهوشا کساله حل‌مبکنن، نابغه اقتصادی فرصت میسارد یا میفروشد یا له عبارتی مساله میفروشن.
برای مسال بازکردن مغازه جدید در مکان جدید با توجه به وضعیت شهر...
Cannot copy easily your solution.
...
<pre>
 Human likes to do repetetive easy task day by day
...
هوش ها-------------------- زبانی: داستان و کلمات و احساسات فردی: ctx فردی. زبان دوم
منطقی: پازل . منطق. سودوکو. شظ
تصویری: نقاشی طراحی مجسمه . مسیر سه بعدی. 
بدنی: دو دست٬ دست غالب. حرکت شعبده بازی. باشگاه و تریک. تایپ
موسیقی : پیانو نت ذهنی
فردی: رفلک و جاج خود
اجتماعی: ارتباظ و یزخوزد مودیانه و دوشستیایب: 
بازی دوستیابی و تحلیل احساسات
====================
حافظه : رقم. تصویر. زبان - writing
پروسس: شط بلانیند ضرب ذهنی. طراجی مسیله و نمودار گراف ها ذهنی: graph and chess
